...
// Obtener datos de la ciudad a modificar
$sql = $con->query("SELECT c.*, e.id_pais 
                    FROM ciudad c 
                    INNER JOIN estado e ON c.id_estado = e.id_estado 
                    WHERE c.id_ciudad = $id");
$datos = $sql->fetch_object();

// Si no existe la ciudad, redirigir
if (!$datos) {
    header("Location: crud_ciudad.php");
    exit();
}
...
// Obtener lista de estados del país seleccionado
$estados = $con->query("SELECT id_estado, Nombre FROM estado WHERE id_pais = {$datos->id_pais} ORDER BY Nombre");

// Obtener lista de ciudades para la tabla
            ...
            <div class="container mt-4">
                ...
                <div class="card mb-4">
                    <div class="card-header bg-warning text-dark">
                        <h4 class="mb-0">Modificar Ciudad</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="" id="formCiudad">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="estado" name="id_estado" required>
                                        ...
                                        <?php while($estado = $estados->fetch_object()): ?>
                                            <option value="<?= $estado->id_estado ?>" <?= ($estado->id_estado == $datos->id_estado) ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="nombre" placeholder="Ej: Valencia" required value="<?= htmlspecialchars($datos->Nombre) ?>">
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php if ($query->num_rows > 0): ?>
                                    ...
                                    <tr <?= ($row->id_ciudad == $id) ? 'class="table-warning"' : '' ?>>
                                        <td><?= $row->id_ciudad ?></td>
                        ...
                        <a href="crud_ciudad.php" class="btn btn-primary">
