        ...
        <main class="main-content clearfix">
            ...
            <div class="nav-panel">
                <center>
                    ...
                    <a href="update_pais.html" class="active">✏️ Actualizar</a>
            ...
            <div class="content-right">
                <div class="section-card crud-panel">
                    ...
                    <form method="POST" onSubmit="return validar(this)" method="POST" action="/SystemRRHH/controlador/ctl_pais.php">
                        ...
                        <input type="hidden" name="nombre_actual" value="<?php echo htmlspecialchars($nombre); ?>">
                        
                        <div class="form-grid">
                            <div class="form-group">
                                <label>Nombre del País *</label>
                                <input type="text" class="form-input" name="nombre" value="<?php echo htmlspecialchars($nombre); ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Código ISO (2 letras)</label>
                                <input type="text" class="form-input" name="codigo_iso" value="<?php echo htmlspecialchars($codigo); ?>" maxlength="2">
                            </div>
                        </div>
                        ...
                        <div class="crud-buttons">
                            ...
                            <a href="maestro_pais.php" class="btn btn-secondary">
                                ❌ Cancelar
                            </a>
                        </div>
                    </form>
                    ...
                    <div style="text-align: center; padding: 40px; color: #dc3545;">
                        ...
                        <a href="update_pais.html" class="btn btn-secondary" style="display: inline-block; margin-top: 10px;">
                            ← Volver a buscar
                        </a>
                    </div>
                    <?php endif; ?>
