...
$check = $con->query("SELECT c.id_ciudad, c.Nombre as ciudad_nombre, 
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning">
                            <h5>¿Estás seguro de eliminar esta ciudad?</h5>
                            <p><strong>ID:</strong> <?= $ciudad->id_ciudad ?></p>
                            <p><strong>Nombre:</strong> <?= htmlspecialchars($ciudad->ciudad_nombre) ?></p>
                            <p><strong>Estado:</strong> <?= htmlspecialchars($ciudad->estado_nombre) ?></p>
                            <p><strong>País:</strong> <?= htmlspecialchars($ciudad->pais_nombre) ?></p>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="crud_ciudad.php" class="btn btn-secondary">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php if ($query->num_rows > 0): ?>
                                    ...
                                    <tr <?= ($row->id_ciudad == $id) ? 'class="table-danger"' : '' ?>>
                                        <td><?= $row->id_ciudad ?></td>
