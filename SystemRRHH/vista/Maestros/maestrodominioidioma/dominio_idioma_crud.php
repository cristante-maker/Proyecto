<?php
// dominio_idioma_crud.php
// Ubicación: SystemRRHH/vista/Maestros/maestrodominioidioma/dominio_idioma_crud.php

require_once __DIR__ . '/../../../controlador/DominioIdiomaController.php';
...
$controller = new DominioIdiomaController();
...
try {
    ...
    switch ($_SERVER['REQUEST_METHOD']) {
        case 'GET':
            ...
            } elseif ($action === 'idiomas') {
                $response = $controller->getIdiomas();
            } else {
