<?php
// vista/Maestros/Maestroestado/select_estado.php

$nombre  = base64_decode($_GET['b'] ?? '');
$pais    = base64_decode($_GET['c'] ?? '');
        ...
        <main class="main-content clearfix">
            ...
            <div class="nav-panel">
                <center>
                    ...
                    <a href="select_estado.html" class="active">🔍 Consultar</a>
                    <a href="update_estado.html">✏️ Actualizar</a>
                    <a href="delete_estado.html">🗑️ Eliminar</a>
                    <a href="maestro_estado.php">📋 Listado</a>
                </center>
            </div>
                ...
                <div class="section-card">
                    ...
                    <div class="detail-card">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?php echo htmlspecialchars($pais); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">🏛️ Capital:</span>
                            <span class="detail-value"><?php echo htmlspecialchars($capital ?: 'No especificada'); ?></span>
                        </div>
                    </div>
                    <?php else: ?>
                    ...
                    <div style="margin-top: 20px;">
                        <a href="maestro_estado.php" class="btn-volver">← Volver al listado</a>
                    </div>
                </div>
            </div>
        </main>
