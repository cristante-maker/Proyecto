...
<head>
    ...
    <title>Editar Familiar - Maestros RRHH</title>
    ...
    <style>
        ...
        @media (max-width: 768px) { .crud-panel .form-grid { grid-template-columns: 1fr; } }
    </style>
            ...
            <div class="content-right">
                <div class="section-card crud-panel">
                    ...
                    <form method="POST" action="/SystemRRHH/controlador/ctl_familia.php" onsubmit="return validarForm(this)">
                        ...
                        <input type="hidden" name="id_familiar" value="<?php echo $v1; ?>">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <select class="form-input" name="Cedula_Emp" required>
                                    ...
                                    <option value="<?php echo $emp['cedula']; ?>" <?php echo $emp['cedula'] == $v2 ? 'selected' : ''; ?>><?php echo htmlspecialchars($emp['cedula'] . ' - ' . $emp['primer_nombre'] . ' ' . $emp['primer_apellido']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Número de Cédula *</label>
                                <input type="text" class="form-input" name="Numero_Cedula" value="<?php echo htmlspecialchars($v3); ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Nombre Completo *</label>
                                <input type="text" class="form-input" name="Nombre_y_Ap" value="<?php echo htmlspecialchars($v4); ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Parentesco *</label>
                                <select class="form-input" name="Parentesco" required>
                                    <option value="">Seleccione...</option>
                                    <option value="Hijo" <?php echo $v5=='Hijo'?'selected':''; ?>>Hijo</option>
                                    <option value="Hija" <?php echo $v5=='Hija'?'selected':''; ?>>Hija</option>
                                    <option value="Cónyuge" <?php echo $v5=='Cónyuge'?'selected':''; ?>>Cónyuge</option>
                                    <option value="Madre" <?php echo $v5=='Madre'?'selected':''; ?>>Madre</option>
                                    <option value="Padre" <?php echo $v5=='Padre'?'selected':''; ?>>Padre</option>
                                    <option value="Hermano" <?php echo $v5=='Hermano'?'selected':''; ?>>Hermano</option>
                                    <option value="Hermana" <?php echo $v5=='Hermana'?'selected':''; ?>>Hermana</option>
                                    <option value="Otro" <?php echo $v5=='Otro'?'selected':''; ?>>Otro</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Sexo</label>
                                <select class="form-input" name="Sexo">
                                    <option value="">Seleccione...</option>
                                    <option value="Masculino" <?php echo $v6=='Masculino'?'selected':''; ?>>Masculino</option>
                                    <option value="Femenino" <?php echo $v6=='Femenino'?'selected':''; ?>>Femenino</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Fecha de Nacimiento</label>
                                <input type="date" class="form-input" name="Fecha_Nac" value="<?php echo htmlspecialchars($v7); ?>">
                            </div>
                            <div class="form-group">
                                <label>Nivel Educativo</label>
                                <input type="text" class="form-input" name="Nivel_educativo" value="<?php echo htmlspecialchars($v8); ?>">
                            </div>
                            <div class="form-group">
                                <label>Convive Colectivamente</label>
                                <select class="form-input" name="Convec_Colectiva">
                                    <option value="">Seleccione...</option>
                                    <option value="Si" <?php echo $v9=='Si'?'selected':''; ?>>Sí</option>
                                    <option value="No" <?php echo $v9=='No'?'selected':''; ?>>No</option>
                                </select>
                            </div>
                        </div>
