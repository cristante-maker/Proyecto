...
$check = $con->query("SELECT e.id_estado, e.Nombre as estado_nombre, p.Nombre as pais_nombre 
                      FROM estado e 
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning">
                            <h5>¿Estás seguro de eliminar este estado?</h5>
                            <p><strong>ID:</strong> <?= $estado->id_estado ?></p>
                            <p><strong>Nombre:</strong> <?= htmlspecialchars($estado->estado_nombre) ?></p>
                            <p><strong>País:</strong> <?= htmlspecialchars($estado->pais_nombre) ?></p>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="crud_estado.php" class="btn btn-secondary">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php if ($query->num_rows > 0): ?>
                                    ...
                                    <tr <?= ($row->id_estado == $id) ? 'class="table-danger"' : '' ?>>
                                        <td><?= $row->id_estado ?></td>
